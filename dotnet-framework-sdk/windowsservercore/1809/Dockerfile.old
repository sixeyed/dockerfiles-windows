...
### source - https://raw.githubusercontent.com/Microsoft/dotnet-framework-docker/rs5/4.7.2/sdk/windowsservercore-ltsc2019/Dockerfile
### amended base image until MSFT's image avaiable
...
### fails - missing .NET 2 & various DLLs
###SHELL ["cmd", "/S", "/C"]
